-- Fixed Archive Function - Removes the profiles join that's causing the error
-- This version doesn't try to fetch profile data during archival
...
BEGIN
    ...
    LOOP
        ...
        INSERT INTO tournaments_history (
            ...
            'expired',
            tournament_record.profiles,  -- This is the creator profile ID from tournaments table
            venue_data
        );

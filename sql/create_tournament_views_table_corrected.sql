...
-- CORRECTED VERSION: Uses UUID for tournament_id to match tournaments.id column type
...
COMMENT ON COLUMN tournament_views.tournament_id IS 'Reference to the tournament being viewed (UUID)';

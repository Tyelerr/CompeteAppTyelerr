-- FINAL CORRECT FIX: Skip past dates entirely, only UPSERT future dates
...
BEGIN
    ...
    LOOP
        ...
        WHILE cursor_date < target_date LOOP
            ...
            -- CRITICAL: Only process if date is in the FUTURE
            -- This prevents trying to reactivate past archived tournaments
            IF cursor_date >= CURRENT_DATE THEN
                ...
                EXCEPTION WHEN OTHERS THEN
                    RAISE WARNING 'Error for series % on %: %', 
...
'Generates recurring tournaments with 60-day horizon. 
Only looks at ACTIVE children when finding latest.
Skips past dates entirely.

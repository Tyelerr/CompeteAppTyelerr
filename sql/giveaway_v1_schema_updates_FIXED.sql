-- ============================================================================
-- GIVEAWAY V1 SCHEMA UPDATES - FIXED FOR ENUM TYPE
-- ============================================================================
-- This script updates the giveaways and giveaway_entries tables to match
-- the Final Giveaway v1 Settings requirements
-- Works with PostgreSQL ENUM types (not CHECK constraints)
-- ============================================================================

-- ============================================================================
-- STEP 1: Update giveaways table - Add new columns first
-- ============================================================================
...
-- ============================================================================
-- STEP 2: Update giveaway_status ENUM type
-- ============================================================================

-- Add new enum values to existing giveaway_status type
...
-- Note: We keep 'draft' and 'active' as they already exist
-- 'scheduled' can be mapped to 'draft' if needed, or kept as-is for now
-- 'archived' can be mapped to 'closed' if it exists

-- Optional: If you want to remove old values, you'd need to:
-- 1. Ensure no rows use them
...
-- ============================================================================
-- STEP 4: Update giveaway_entries table
-- ============================================================================
...
-- ============================================================================
-- STEP 5: Create giveaway_winners table
-- ============================================================================
...
BEGIN
  ...
  RAISE NOTICE 'Current giveaway_status enum values: %', v_enum_values;

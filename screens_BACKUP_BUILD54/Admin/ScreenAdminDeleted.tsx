...
import { ETournamentStatuses, ETournamentTimeDeleted, GameTypes, ITournament, TournamentStatusesForDropdown } from "../../hooks/InterfacesGlobal";
...
export default function ScreenAdminDeleted(){
  ...
  const [lastDeleted, set_lastDeleted] = useState<string>('');
  ...
  const _LoadTournaments = async ()=>{
    const {
      ...
      filterVenue,
      filterId,
      ETournamentStatuses.Deleted, // this is for the status, here should be pending
      {
        sortBy: sortBy,
      ...
      <View style={[
        ...
        <View style={[
          ...
          <View style={[
            ...
            <View style={[
              ...
              <LFInput 
                ...
                onChangeText={(text:string)=>{
                  set_lastDeleted(text);
                }}
                validations={[
                  // EInputValidation.Required,
                ]}
                items={[
                  {label: 'All Time', value: ETournamentTimeDeleted.AllTime},
                  {label: 'Last 7 Days', value: ETournamentTimeDeleted.Last7Days},
                  {label: 'Last 30 Days', value: ETournamentTimeDeleted.Last30Days}
                ]}
                />
            </View>
          </View>
          ...
          <AdminTournamentsFIlters
            ...
            tournament_status_static_value={ETournamentStatuses.Deleted}
          />

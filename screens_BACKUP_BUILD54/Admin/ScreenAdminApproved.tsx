...
import AdminTournamentsListSimple from './AdminTournamentsListSimple';
import AdminTournamentsFIlters, {
  IAdminTournamentsFilters,
} from './AdminTournamentsFIlters';

export default function ScreenAdminApproved() {
  ...
  const _LoadTournaments = async ()=>{
    const {
      ...
      filterVenue,
      filterId,
      ETournamentStatuses.Approved, // this is for the status, here should be pending
      {
        sortBy: sortBy,
  ...
  */
  const [filters, set_filters] = useState<IAdminTournamentsFilters | null>(
    null,
  );
      ...
      <ScreenScrollView>
        <View>
          ...
          <View style={[StyleZ.loginFromContainer]}>
            <View style={[StyleZ.loginForm, { borderWidth: 0 }]}>
              {/*<LFInput 
          ...
          <View style={[
            ...
            <LFInput 
              ...
              items={[
                // {label:'Any Status', value: ''}, ...TournamentStatusesForDropdown
              ]}
              />
          </View>
          ...
          <View style={{
            ...
            <View style={{
              ...
              <AdminTournamentsFIlters
                ...
                tournament_status_static_value={ETournamentStatuses.Approved}
              />
              ...
              <AdminTournamentsListSimple filters={filters} />
            </View>
          </View>
        </View>
      </ScreenScrollView>

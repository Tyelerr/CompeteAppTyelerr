...
const ModalCreateVenue: React.FC<ModalCreateVenueProps> = ({
  ...
  const submit = async () => {
    ...
    console.log('barownerId:', barownerId);
    console.log('barownerId type:', typeof barownerId);
    console.log('editingVenue:', editingVenue ? 'Yes' : 'No');
    ...
    try {
      ...
      if (editingVenue) {
        ...
        console.log('createVenue result:', venue);
      }
      ...
      if (venue) {
        ...
        console.error('❌ createVenue returned null');
        Alert.alert(
          'Error',
          `Failed to ${
            editingVenue ? 'update' : 'create'
          } venue. Check console for details.`,
        );
      }
    } catch (error) {
      ...
      Alert.alert(
        'Error',
        `Failed to ${editingVenue ? 'update' : 'create'} venue. Error: ${

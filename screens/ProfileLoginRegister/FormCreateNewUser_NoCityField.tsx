// screens/ProfileLoginRegister/FormCreateNewUser_NoCityField.tsx
...
export default function FormCreateNewUser(props: Props) {
  ...
  async function handleSubmit() {
    ...
    try {
      ...
      // 2) Update profile with home state and role (if admin mode) - NO HOME CITY
      ...
      // 5) Clear form and validation states
      setEmail('');
      setUserName('');
      setPassword('');
      setConfirmPassword('');

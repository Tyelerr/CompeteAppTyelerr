...
export default function ScreenUserMessages() {
    ...
    >
      <View style={{ padding: BasePaddingsMargins.m15 }}>
        ...
        <UIPanel>
          ...
          >
            <Text style={[StyleZ.h4, { color: 'white' }]}>
          ...
          <Text style={[StyleZ.p, { color: BaseColors.othertexts }]}>
            View your support requests and admin responses here. You'll receive
            notifications when admins reply to your messages.
          </Text>
        </UIPanel>
        ...
        <UIPanel>
          ...
          <Text
            style={[StyleZ.p, { color: BaseColors.othertexts, lineHeight: 20 }]}
          >
            If you need to send a new support message, you can do so through the
            Contact/Support section in the app. Admin responses will appear
            here, and you'll be notified when new replies are available.
          </Text>
        </UIPanel>
      </View>
    </ScreenScrollView>

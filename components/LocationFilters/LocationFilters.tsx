...
export default function LocationFilters({
  ...
  useEffect(() => {
    if (resetComponent !== undefined) {
      ...
      // Reset to user's home state and city if available, else clear
      const resetState = userProfile?.home_state || '';
      const resetCity = userProfile?.home_city || '';
      ...
      // Update filters with user's home state and city
      const updatedFilters: ITournamentFilters = {
        ...filters,
        state: resetState || undefined,
        city: resetCity || undefined,
        zip_code: undefined,
        radius: 25,
      };

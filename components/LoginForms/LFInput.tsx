...
import { CapitalizeWords, CapitalizeGameName } from '../../hooks/hooks';
    ...
    const commonProps = {
      ...
      onBlur: () => {
        if (displayValue !== '' && onChangeText) {
          if (capitalizeGameName === true) {
            onChangeText(CapitalizeGameName(displayValue));
          } else if (capitalizeTheWords === true) {

// components/LoginForms/LFInput_DropdownFixed.tsx
...
export default function LFInputDropdownFixed({
  keyboardType,
  typeInput = 'default',
  label,
  isPassword,
  ...
  const _input = () => {
        ...
        <View>
          <RNPickerSelect
            ...
            onValueChange={(v, index: number) => {
              ...
              // FIXED: Use the correct index without subtracting 1
              set_dropdownIndexSelected(index);
            }}
            items={items}
            placeholder={
              ...
              <View>
                ...
                >
                  {((): string => {
                    ...
                    // FIXED: Find the correct label by value instead of using index
                    if (text !== '') {
    ...
    const commonProps = {
      ...
      // FIXED: Comprehensive autofill prevention to stop flickering

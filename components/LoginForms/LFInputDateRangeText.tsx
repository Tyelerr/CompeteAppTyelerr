...
import LFInputDateText from './LFInputDateText';

interface LFInputDateRangeTextProps {
  label: string;
  dateFrom?: string;
  dateTo?: string;
...
export default function LFInputDateRangeText({
  label,
  dateFrom,
  dateTo,
  onDateFromChange,
  ...
  placeholder = { from: 'From Date (MM/DD/YYYY)', to: 'To Date (MM/DD/YYYY)' },
}: LFInputDateRangeTextProps): React.ReactElement {
